//! Snapshot tests for the TypeScript emitter.

use typewriter_core::ir::*;
use typewriter_core::mapper::TypeMapper;
use typewriter_typescript::TypeScriptMapper;
...
#[test]
fn test_readonly_struct_snapshot() {
    let mapper = TypeScriptMapper::new().with_readonly(true);
    let def = TypeDef::Struct(StructDef {
